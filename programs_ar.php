    ...
    <nav>
     ...
     <div class="menu">
      <div class="data">
           <ul>
                        <li>Code4Yemen</li>
                        <li><a href="ar.php">الرئيسية</a></li>
                        <li><a href="ar.php#about">عنا</a></li>
          ...
          <div class="about-program section" >
            ...
            <div class="bootstrap-wrapper">
              ...
              <div class="row">
                ...
                <div class="col-lg-6">
                  <div class="about-program-title">
                    <div id="about-program_img">
                  ...
                  <div class="bootstrap-wrapper">
                      <div class="container">
                          ...
                          <div class="owl-carousel">
                            <div class="student">
                                <div class="std-img">
                                  <img src="images/ahmed.png" alt="" class="pic">
                                </div>
                          ...
                          <div class="student">
                            <div class="std-img">
                            <img src="images/ayman.png" alt="" class="pic">
                        </div>
            ...
            <div class="col-lg-6">
              <div class="contact-form">
                <form method="POST"  id="myfrom">
                  ...
                  <textarea name="message" id="message" placeholder="الرساله *" required></textarea>
